...
class LevelUp():
    ...
    def drawScreen(self):
        ...
        write(self.game, 25, 40, 370, f'ATK SP: Level {self.character.type.attackMagicLevel[self.character.level-2]} -> {self.character.type.attackMagicLevel[self.character.level-1]}')
        write(self.game, 25, 40, 400, f'SPT SP: Level {self.character.type.supportMagicLevel[self.character.level-2]} -> {self.character.type.supportMagicLevel[self.character.level-1]}')
