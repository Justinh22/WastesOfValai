...
def initAtkSpellDirectory():
    ...
    Thunder_Wave_II = AttackMagic("Thunder Wave II","Hurls a large wave of electricity toward all foes.",2,312,14,16,SpellType.Attack,Element.Lightning,Target.All)
    attackSpellDirectory.append(Thunder_Wave_II)
    Fire_Wave_II = AttackMagic("Fire Wave II","Hurls a large wave of flame toward all foes.",2,313,13,14,SpellType.Attack,Element.Fire,Target.All)
    attackSpellDirectory.append(Fire_Wave_II)
    Frost_Wave_II = AttackMagic("Frost Wave II","Hurls a large wave of ice toward all foes.",2,314,12,12,SpellType.Attack,Element.Ice,Target.All)
    ...
    Thunder_Wave_III = AttackMagic("Thunder Wave III","Launches a massive wave of electricity toward all foes.",2,318,18,22,SpellType.Attack,Element.Lightning,Target.All)
    attackSpellDirectory.append(Thunder_Wave_III)
    Fire_Wave_III = AttackMagic("Fire Wave III","Launches a massive wave of flame toward all foes.",2,319,17,20,SpellType.Attack,Element.Fire,Target.All)
    attackSpellDirectory.append(Fire_Wave_III)
    Frost_Wave_III = AttackMagic("Frost Wave III","Launches a massive wave of ice toward all foes.",2,320,16,18,SpellType.Attack,Element.Ice,Target.All)
...
def initSptSpellDirectory():
    ...
    Rage_Aura =  SupportMagic("Rage Aura","Increases your party's Atk.",1,421,[5,0,0,0,0,0,0],20,SpellType.Buff,Target.All)
    sptSpellDirectory.append(Rage_Aura)
    Focus_Aura = SupportMagic("Focus Aura","Increases your party's Acc.",1,422,[0,15,0,0,0,0,0],20,SpellType.Buff,Target.All)
    sptSpellDirectory.append(Focus_Aura)
    Sense_Aura = SupportMagic("Sense Aura","Increases your party's Crt.",1,423,[0,0,15,0,0,0,0],20,SpellType.Buff,Target.All)
    sptSpellDirectory.append(Sense_Aura)
    Brace_Aura = SupportMagic("Brace Aura","Increases your party's Def.",1,424,[0,0,0,5,0,0,0],20,SpellType.Buff,Target.All)
    sptSpellDirectory.append(Brace_Aura)
    Speed_Aura = SupportMagic("Speed Aura","Increases your party's Ddg.",1,425,[0,0,0,0,15,0,0],20,SpellType.Buff,Target.All)
    sptSpellDirectory.append(Speed_Aura)
    Fortune_Aura = SupportMagic("Fortune Aura","Increases your party's Lck.",1,426,[0,0,0,0,0,15,0],20,SpellType.Buff,Target.All)
    sptSpellDirectory.append(Fortune_Aura)
    Minor_Heal_Aura = SupportMagic("Minor Heal Aura","Heals all party members for a small amount of health.",1,427,[0,0,0,0,0,0,10],12,SpellType.Heal,Target.All)
    ...
    Rally_Aura = SupportMagic("Rally Aura","Increases your party's Atk and Def.",2,435,[5,0,0,5,0,0,0],28,SpellType.Buff,Target.All)
    sptSpellDirectory.append(Rally_Aura)
    Wrath_Aura = SupportMagic("Wrath Aura","Increases your party's Atk and Acc.",2,436,[5,15,0,0,0,0,0],28,SpellType.Buff,Target.All)
    sptSpellDirectory.append(Wrath_Aura)
    Precision_Aura = SupportMagic("Precision Aura","Increases your party's Acc and Crt.",2,437,[0,15,15,0,0,0,0],28,SpellType.Buff,Target.All)
    sptSpellDirectory.append(Precision_Aura)
    Trance_Aura = SupportMagic("Trance Aura","Increases your party's Acc and Ddg.",2,438,[0,15,0,0,15,0,0],28,SpellType.Buff,Target.All)
    sptSpellDirectory.append(Trance_Aura)
    Veil_Aura = SupportMagic("Veil Aura","Increases your party's Def and Ddg.",2,439,[0,0,0,5,15,0,0],28,SpellType.Buff,Target.All)
    sptSpellDirectory.append(Veil_Aura)
    Fate_Aura = SupportMagic("Fate Aura","Increases your party's Crt and Lck.",2,440,[0,0,15,0,0,15,0],28,SpellType.Buff,Target.All)
    ...
    Heal_Aura = SupportMagic("Heal Aura","Heals all party members for a moderate amount of health.",1,442,[0,0,0,0,0,0,30],30,SpellType.Heal,Target.All)
    sptSpellDirectory.append(Heal_Aura)
    Minor_Regenerate_Aura = SupportMagic("Minor Regenerate Aura","Heals all party members for a small amount of health over time.",2,443,[0,0,0,0,0,0,6],24,SpellType.Buff,Target.All)
    ...
    #5
    Rage_Aura_II =  SupportMagic("Rage Aura II","Increases your party's Atk by a great amount.",1,446,[10,0,0,0,0,0,0],32,SpellType.Buff,Target.All)
    sptSpellDirectory.append(Rage_Aura_II)
    Focus_Aura_II = SupportMagic("Focus Aura II","Increases your party's Acc by a great amount.",1,447,[0,30,0,0,0,0,0],32,SpellType.Buff,Target.All)
    sptSpellDirectory.append(Focus_Aura_II)
    Sense_Aura_II = SupportMagic("Sense Aura II","Increases your party's Crt by a great amount.",1,448,[0,0,30,0,0,0,0],32,SpellType.Buff,Target.All)
    sptSpellDirectory.append(Sense_Aura_II)
    Brace_Aura_II = SupportMagic("Brace Aura II","Increases your party's Def by a great amount.",1,449,[0,0,0,10,0,0,0],32,SpellType.Buff,Target.All)
    sptSpellDirectory.append(Brace_Aura_II)
    Speed_Aura_II = SupportMagic("Speed Aura II","Increases your party's Ddg by a great amount.",1,450,[0,0,0,0,30,0,0],32,SpellType.Buff,Target.All)
    sptSpellDirectory.append(Speed_Aura_II)
    Fortune_Aura_II = SupportMagic("Fortune Aura II","Increases your party's Lck by a great amount.",1,451,[0,0,0,0,0,30,0],32,SpellType.Buff,Target.All)
    sptSpellDirectory.append(Fortune_Aura_II)
    Spectrum_Aura = SupportMagic("Spectrum Aura","Increases all stats for all party members.",2,452,[5,5,15,5,5,15,0],40,SpellType.Buff,Target.All)
    ...
    Regenerate_Aura = SupportMagic("Regenerate Aura","Heals all party members for a moderate amount of health over time.",2,454,[0,0,0,0,0,0,12],40,SpellType.Buff,Target.All)
    sptSpellDirectory.append(Regenerate_Aura)
    Raise_Aura = SupportMagic("Raise Aura","Raises all fallen party members from the dead with 30 HP.",2,455,[0,0,0,0,0,0,30],50,SpellType.Raise,Target.All)
